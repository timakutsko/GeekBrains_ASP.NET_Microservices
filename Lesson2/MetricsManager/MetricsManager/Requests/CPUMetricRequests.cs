...
namespace MetricsManager.Requests
{
	...
	/// </summary>
	public class CPUMetricGetByIntervalForClusterRequest : IMetricGetByIntervalForClusterRequest
	{
	...
	/// Контейнер для запроса метрик из базы
	/// </summary>
	public class CPUMetricGetByIntervalForAgentRequest : IMetricGetByIntervalForAgentRequest
	{
