...
namespace MetricsManager.Requests
{
	...
	/// </summary>
	public class NetworkMetricGetByIntervalForClusterRequest : IMetricGetByIntervalForClusterRequest
	{
	...
	/// Контейнер для запроса метрик из базы
	/// </summary>
	public class NetworkMetricGetByIntervalForAgentRequest : IMetricGetByIntervalForAgentRequest
	{
