...
namespace MetricsManager.DAL.Repositories
{
	...
	/// </summary>
	public interface INETMetricsRepository : IRepository<AllMetrics<NETMetric>>
	{
	}
	...
	public class NETMetricsRepository : INETMetricsRepository
	{
		...
		public NETMetricsRepository(IMySqlSettings mySqlSettings, ILogger<NETMetricsRepository> logger)
		{
		...
		public void Create(AllMetrics<NETMetric> metrics)
		{
				...
				using (var transaction = connection.BeginTransaction())
				{
					try
					{
						foreach (var metric in metrics.Metrics)
						{
							...
							$"INSERT INTO {mySql[Tables.NETMetric]}" +
		...
		public AllMetrics<NETMetric> GetByTimeInterval(int agentId, DateTimeOffset fromTime, DateTimeOffset toTime)
		{
			var metrics = new AllMetrics<NETMetric>();
			using (var connection = new SQLiteConnection(mySql.ConnectionString))
			{
				try
				{
					metrics.Metrics = connection.Query<NETMetric>(
					"SELECT * " +
					$"FROM {mySql[Tables.NETMetric]} " +
					$"WHERE (" +
		...
		public AllMetrics<NETMetric> GetByTimeIntervalPercentile(
			int agentId,
			...
			Percentile percentile)
		{
			...
			var returnMetrics = new AllMetrics<NETMetric>();
